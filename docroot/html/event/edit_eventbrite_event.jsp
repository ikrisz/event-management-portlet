...
<c:set var="showEventbriteVenue" value="${not empty availableVenues}" scope="request"/>
<c:set var="showRecurrencyDates" value="false" scope="request"/>
<c:set var="showMultidayDates" value="false" scope="request"/>
<c:set var="showEventbriteGeneralFields" value="true" scope="request"/>
	...
	<div class="container-fluid">
		<div class="panel panel-default">
			...
			<div class="panel-body accordion">
				...
				<jsp:include page="event_update_sections/organizer.jsp"/>
				<jsp:include page="event_update_sections/venue.jsp"/>
				<jsp:include page="event_update_sections/payment.jsp"/>
				<jsp:include page="event_update_sections/tickets.jsp"/>
				<jsp:include page="event_update_sections/tags.jsp"/>
			</div>

			<div class="panel-footer">
				<button class="btn btn-primary" id="<portlet:namespace/>submitUpdateEvent"><span class="icon-ok"></span>&nbsp;<liferay-ui:message key="button.save"/> </button>
...
jQuery(document).ready(function(){
	...
	intelligusEvent.InitializeEventbriteEventUpdate('${namespace}', eventConfirmMessage, '${event.dates.allDay}', '${event.organizer.organizerId}', '${event.venue.venueId}', '${event.venue.online}', '${event.venue.country}', '${event.venue.regionState}');
});
